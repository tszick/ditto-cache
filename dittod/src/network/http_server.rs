...
async fn handle_health_summary(State(node): State<Arc<NodeHandle>>) -> Response {
    ...
    let body = serde_json::json!({
        ...
        "hot_key_wait_timeout_total": stats.hot_key_wait_timeout_total,
        "hot_key_stale_served_total": stats.hot_key_stale_served_total,
        "hot_key_stale_cache_entries": stats.hot_key_stale_cache_entries,
        "hot_key_adaptive_waiters_enabled": stats.hot_key_adaptive_waiters_enabled,
        "hot_key_adaptive_state_keys": stats.hot_key_adaptive_state_keys,
        "hot_key_adaptive_limit_increase_total": stats.hot_key_adaptive_limit_increase_total,
        "hot_key_adaptive_limit_decrease_total": stats.hot_key_adaptive_limit_decrease_total,
        ...
        "read_repair_budget_exhausted_total": stats.read_repair_budget_exhausted_total,
        ...
        "anti_entropy_budget_exhausted_total": stats.anti_entropy_budget_exhausted_total,
        ...
        "namespace_latency_top": stats.namespace_latency_top,
        "hot_key_top_usage": stats.hot_key_top_usage,
