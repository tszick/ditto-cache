...
impl Default for CompressionConfig {
    fn default() -> Self {
        Self { enabled: true, threshold_bytes: 4096 }
    }
}
...
impl Default for TlsConfig {
    fn default() -> Self {
        Self { enabled: false, ca_cert: String::new(), cert: String::new(), key: String::new() }
    }
}
...
fn default_cluster_bind_addr() -> String { "site-local".into() }
fn default_max_nodes() -> usize { 100 }
fn default_version_check_interval_ms() -> u64 { 30_000 }
fn default_eviction_policy() -> String { "lfu".to_string() }
fn default_gossip_dead_ms() -> u64 { 1000 }
fn default_value_size_limit() -> u64 { 100 * 1024 * 1024 } // 100 MiB
fn default_max_keys() -> usize { 100_000 }
